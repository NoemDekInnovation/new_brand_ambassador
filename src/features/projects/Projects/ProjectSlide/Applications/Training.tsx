              ...
              <div className=" md:max-w-[520px] w-full whitespace-nowrap gap-4 flex md:flex-1 ">
                <Select>
                  ...
                  <SelectContent className="z-[2500] bg-white text-[12px]">
                    <SelectGroup>
                      <SelectItem value="send-contract">
                        Send Contract
                      </SelectItem>
                ...
                <Select>
                  ...
                  <SelectContent className="z-[2500] bg-white text-[12px]">
                    <SelectGroup className="text-[12px]">
                      <SelectItem value="contract-offerees">
                        Contract Offerees{" "}
                      </SelectItem>
                      <SelectItem value="all-training-invitees">
                        All Training Invitees
                      </SelectItem>{" "}
                      <SelectItem value="invitees-brand-ambassador">
                        Invitees(Brand Ambassador)
                      </SelectItem>
                      <SelectItem value="invitees-supervisor">
                        Invitees(Brand Supervisor)
                      </SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
