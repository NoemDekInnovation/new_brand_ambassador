            ...
            <div className="" key={idx}>
              <CardContent className="p-0 space-y-1">
                <div className="flex space-x-2">
                  ...
                  <p className="text-bm__niv text-[10px] ">Ongoing</p>
        ...
        <TabsList className="p-0 justify-start gap-4 flex">
          <TabsTrigger className="px-0" value="posted">
            <div className="flex space-x-1 items-center">
              <p className="text-bm_black text-[8px]">Posted</p>
          ...
          {[1, 2, 3].map((_, idx) => {
            return (
              <div className="" key={idx}>
                <CardContent className="p-0 space-y-1">
                  <div className="flex space-x-2">
                    <h3 className="font-medium text-[15px] border-r pr-2">
                      Project Name
                    </h3>
                    <p className="text-bm_card__orange text-[14px] ">Posted</p>
                  </div>
                  <p className="font-normal text-[13px]">
                    This is the project description.{" "}
                  </p>
