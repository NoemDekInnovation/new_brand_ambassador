  ...
  return (
    <MainLayout>
      <div className='flex overflow-hidden h-[85vh] bg-bm_card_grey'>
        <Footer />
        <div className=' flex py-10 md:space-x-8 flex-col items-center space-y-8 md:flex-row md:space-y-0 md:items-start bg-bm_card_grey overflow-y-scroll'>
              ...
              <div className=' flex w-full gap-4 h-fit'>
                ...
                <div className='flex-1 flex flex-col gap-2'>
                  ...
                  <Card className=' p-6 flex flex-col justify-center gap-2 bg-white  border-bm__beige w-full  border rounded-[6px]'>
                    ...
                    <Separator className='bg-bm__gler/50' />
                    <p className='text-[12px] font-normal'>
                      Lorem ipsum dolor sit amet consectetur. Tristique egestas
                      nulla a ac imperdiet in. A dignissim neque risus mattis.
                      Justo sed pretium tristique aliquam. Tempus in elementum
                      arcu suscipit. Neque volutpat placerat sem sem quis.
                    </p>
                  </Card>
                  <Card className=' p-6 flex flex-col justify-center gap-2 bg-white  border-bm__beige w-full  border rounded-[6px]'>
                    <p className='text-[15px] font-medium'>Personal Details</p>
                    <Separator className='bg-bm__gler/50' />
